...
const Home = () => {
  ...
  return (
    <section className="relative flex flex-col justify-center h-screen">
        ...
        <div className="inline-flex flex-col items-center justify-center max-w-full gap-8">
            ...
            <div className="justify-center items-center gap-2.5 inline-flex font-goia-medium text-xl font-normal max-sm:flex-col w-full max-sm:px-5 max-sm:max-w-[330px]">
                <button onClick={SummarizeNowButton} className="px-[25px] h-[52px] bg-like-yellow rounded-xl justify-center items-center gap-2.5 flex text-near-black max-sm:w-full">
                    Summarize Now
                </button>
                <a href="https://github.com/ABHAY-100/swift-summarizer" target="_blank" className="px-[25px] h-[52px] rounded-xl border-2 border-shadow-gray-dark justify-center items-center gap-2.5 flex max-sm:w-full text-white hover:bg-subtle-shadow-gray ease-in-out duration-100">
