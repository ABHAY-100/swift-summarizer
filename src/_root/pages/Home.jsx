    ...
    <>
      <section className="relative flex flex-col justify-center h-screen mx-auto bg-near-black">
          ...
          <div className="inline-flex flex-col items-center justify-center max-w-full gap-8 max-[480px]:scale-95">
              ...
              <div className="justify-center items-center gap-2.5 inline-flex font-goia-medium text-xl font-normal max-sm:flex-col w-full max-sm:px-5 max-sm:max-w-[320px] text-[18px]">
                  <button onClick={SummarizeNowButton} className="px-[25px] h-[52px] bg-like-yellow-light rounded-xl justify-center items-center gap-2.5 flex text-near-black max-sm:w-full">
                      Summarize Now
                  </button>
